...
(() => {
  ...
  const I18N = {
    de: {
      ...
      connLive: 'Mit dabei:',
      cloudNote: 'Online-Fassung — läuft ohne Installation. Zeit, Timer, Aufgaben, Notizen, Rechnen und Umrechnen arbeiten hier vollständig. Sprechen geht nur außerhalb dieses Rahmens. Wetter, Wikipedia, KI-Modus, Dateien, Connectors und Agent brauchen den Dienst auf dem eigenen Rechner.',
      ...
      remoteNotice: 'Diese Seite läuft im Netz, nicht auf deinem Rechner. Alles Eingebaute funktioniert hier — Zeit, Timer, Aufgaben, Notizen, Rechnen, Umrechnen — und mit eigenem Schlüssel auch freie Fragen. Nur der Agent braucht den Dienst auf deinem Rechner: läuft der bereits, öffne dort http://localhost:8787/ statt dieser Adresse.',
      ...
      remoteSetting: 'Auf dieser Online-Seite nicht verfügbar. Läuft der Dienst schon auf deinem Rechner, öffne dort http://localhost:8787/ — dieselbe Oberfläche, aber mit freigeschaltetem Agenten.',
      notPossibleHere: 'hier nicht möglich',
      voiceKeyWarn: 'Achtung: Dieser Schlüssel liegt im Browser-Speicher dieses Geräts und geht direkt an api.elevenlabs.io. Nur für die private Nutzung am eigenen Gerät.',
      vmBalanced: 'eleven_multilingual_v2 — ausgewogen',
      vmFast: 'eleven_flash_v2_5 — schnellste Antwort',
      vmTurbo: 'eleven_turbo_v2_5 — schnell',
      vmRich: 'eleven_v3 — ausdrucksstärkste',
    ...
    en: {
      ...
      cloudNote: 'Online version — runs with no installation. Time, timers, tasks, notes, arithmetic and conversions work fully here. Talking only works outside this frame. Weather, Wikipedia, AI mode, files, connectors and the agent need the service on your own machine.',
      ...
      remoteNotice: 'This page runs on the web, not on your computer. Everything built in works here — time, timers, tasks, notes, maths, conversions — and open questions too, with your own key. Only the agent needs the service on your machine: if it is already running, open http://localhost:8787/ there instead of this address.',
      ...
      remoteSetting: 'Not available on this online page. If the service is already running on your computer, open http://localhost:8787/ there instead — same interface, with the agent unlocked.',
      notPossibleHere: 'not possible here',
      voiceKeyWarn: 'Careful: this key is stored in this device’s browser storage and sent straight to api.elevenlabs.io. Private use on your own device only.',
      vmBalanced: 'eleven_multilingual_v2 — balanced',
      vmFast: 'eleven_flash_v2_5 — fastest reply',
      vmTurbo: 'eleven_turbo_v2_5 — fast',
      vmRich: 'eleven_v3 — most expressive',
